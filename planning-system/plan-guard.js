...
const SNAPSHOTS_DIR = 'K:/PortableApps/Claude-Code/planning-system/snapshots';
const GUARD_STATE_FILE = 'K:/PortableApps/Claude-Code/planning-system/guard-state.json';
