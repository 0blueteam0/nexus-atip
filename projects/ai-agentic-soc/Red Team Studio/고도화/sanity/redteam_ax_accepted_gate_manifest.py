...
def accepted_gates() -> list[dict]:
    ...
    return [
        ...
        {
            "gate_id": "GATE-DEVELOPMENT-BYPRODUCT-EXCLUSION",
            "name": "Development byproduct exclusion review",
            "category": "completion_audit",
            "cwd": REDTEAM_ROOT,
            "command": [py, "고도화/sanity/redteam_ax_development_byproduct_exclusion_review.py"],
            "timeout_seconds": 60,
        },
        {
            "gate_id": "GATE-DEVELOPMENT-BYPRODUCT-EXCLUSION-SANITY",
            "name": "Development byproduct exclusion sanity",
            "category": "completion_audit",
            "cwd": REDTEAM_ROOT,
            "command": [py, "고도화/sanity/test_development_byproduct_exclusion_review.py"],
            "timeout_seconds": 60,
        },
        {
        ...
        {
            "gate_id": "GATE-SCANNER-CLI-LIVE-SMOKE",
            "name": "Governed Nuclei and Trivy portable CLI live smoke",
            "category": "scanner_cli_runtime_smoke",
            "cwd": REDTEAM_ROOT,
            "command": [py, "고도화/sanity/redteam_ax_scanner_cli_live_smoke.py"],
            "timeout_seconds": 180,
        },
        {
            "gate_id": "GATE-OPENVAS-ZAP-CLI-LIVE-SMOKE",
            "name": "Governed OpenVAS gvm-cli and ZAP CLI wrapper live smoke",
            "category": "scanner_cli_runtime_smoke",
            "cwd": REDTEAM_ROOT,
            "command": [py, "고도화/sanity/redteam_ax_openvas_zap_cli_live_smoke.py"],
            "timeout_seconds": 240,
        },
        {
        ...
        },
        {
            ...
            "cwd": REDTEAM_ROOT,
            "command": [py, "고도화/sanity/redteam_ax_external_scanner_service_readiness.py"],
            "timeout_seconds": 60,
        },
        {
            "gate_id": "GATE-EXTERNAL-SCANNER-SERVICE-IMPORT-LIVE",
            "name": "External OpenVAS and ZAP read-only service import live smoke harness",
            "category": "external_scanner_service_import_live",
            "cwd": REDTEAM_ROOT,
            "command": [py, "고도화/sanity/redteam_ax_external_scanner_service_import_live_smoke.py"],
            "timeout_seconds": 120,
        },
        {
        ...
        {
            "gate_id": "GATE-STRICT-LIVE-READINESS-PROMOTION",
            "name": "Strict live readiness promotion artifact and blocker rollup",
            "category": "strict_live_readiness_promotion",
            "cwd": REDTEAM_ROOT,
            "command": [py, "고도화/sanity/redteam_ax_strict_live_readiness_promotion.py"],
            "timeout_seconds": 180,
        },
        {
        ...
        {
            "gate_id": "GATE-OPERATOR-EVIDENCE-COLLECTION-PACKAGE",
            "name": "Operator evidence collection package artifact",
            "category": "operator_evidence_collection_package",
            "cwd": REDTEAM_ROOT,
            "command": [py, "고도화/sanity/redteam_ax_operator_evidence_collection_package.py"],
            "timeout_seconds": 60,
        },
        {
        ...
        },
        {
            ...
            "command": [
                ...
                "Red Team Studio/고도화/sanity/redteam_ax_development_byproduct_exclusion_review.py",
                "Red Team Studio/고도화/sanity/test_development_byproduct_exclusion_review.py",
                "Red Team Studio/고도화/sanity/redteam_ax_external_scanner_service_readiness.py",
                "Red Team Studio/고도화/sanity/redteam_ax_external_scanner_service_import_live_smoke.py",
