...
REQUIRED_KOREAN_ANCHORS = [
    ...
    "능동 스캔은 실행하지 않습니다",
    "분석가용 다음 실행 안내",
    "분석가는 결과 첨부, 증거 후보 확인, 보고서 주장 검토 순서로 진행합니다",
    "분석 환경 설정(관리자용)",
    ...
    "상세 진행 기록(관리자/감사용)",
    "사용자 안내",
    "결과가 준비되면 회수·증거 후보 단계와 검토 우선순위가 표시됩니다",
    "운영 산출물 묶음 만들기",
    ...
    "증거 사용 제한",
    "결과 회수 뒤 표시됩니다",
    "도구별 결과 정리와 증거 사용 제한을 표시",
    "분석 결과 쉬운 요약",
    "확인 후보",
    "심각도 분포",
    "도구별 분석 요약",
    "검토 우선순위",
    "세부 실행 ID와 저장 위치는 관리자 감사 기록과 증거 카드에서 추적합니다",
    "필수 6개 분석도구",
    "필수 6개 분석도구",
    "Nuclei/OpenVAS/Trivy/SCA/npm audit/ZAP 6개 결과 확인 상태",
    "완료 게이트 미준비",
    "CycloneDX SBOM",
    "컴포넌트 인벤토리 증거",
    "취약점 후보 증거",
    ...
    "복합 증거 후보 승인",
    "증거 후보 승인",
    "복합 증거 후보 승인은 후보 증거만 승인하며",
    "발견사항 생성·심각도 승인·보고서 반영은 별도 단계로 남깁니다",
    "복합 발견사항 초안 생성",
    "발견사항 초안 생성",
    "승인된 증거만 검토 대기 발견사항 초안으로 만들고",
    "2인 심각도 승인 전에는 주장-증거표와 보고서 주장에 넣지 않습니다",
    "복합 발견사항 심각도 2인 승인",
    "발견사항 심각도 2인 승인",
    "레드팀 리드와 업무 소유자가 같은 심각도를 승인해야",
    "보고서 생성은 주장-증거표 검증 이후에만 진행합니다",
    "복합 주장-증거표 초안",
    "주장-증거표 초안 생성",
    "승인된 증거와 2인 승인 발견사항만 준비 항목으로 구성하며",
    "보류 항목은 보고서 입력에서 제외합니다",
    "복합 보고서 v2 초안",
    "보고서 v2 초안 생성",
    "최종 내보내기 승인은 별도로 남깁니다",
    ...
    "복합 Collection E2E 완료 게이트",
    "기존 산출물만 읽어 증거 승인, 발견사항 승격, 2인 심각도 승인, 주장-증거표 준비, 보고서 검증, 내보내기 완료를 한 번에 점검합니다",
    "복합 Collection 전체 닫기",
    "운영 산출물 전체 닫기",
    "실제 운영 증거 사전 점검",
    "필수 분석도구 산출물",
