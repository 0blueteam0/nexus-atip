...
| Runtime readiness API | `/api/redteam/v2/runtime-readiness` | 최신 container runtime smoke, WSL runtime readiness, external scanner readiness artifact를 read-only로 합쳐 Docker/WSL/OpenVAS/ZAP blocker와 operator next steps 반환 |
