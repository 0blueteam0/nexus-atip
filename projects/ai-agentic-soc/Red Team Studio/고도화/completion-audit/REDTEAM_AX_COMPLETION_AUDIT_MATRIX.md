...
| 상태 | 건수 | 의미 |
|---|---:|---|
| `proved` | 22 | 현재 소스/테스트/스모크 산출물로 해당 범위를 주장 가능 |
...
- 실제 운영 toolchain collection Evidence 후보 전체를 batch 승인 API로 승인하고, 이후 Finding 승격·2인 severity 승인·Matrix/report gate까지 닫은 증거
