...
| 상태 | 건수 | 의미 |
|---|---:|---|
| `proved` | 17 | 현재 소스/테스트/스모크 산출물로 해당 범위를 주장 가능 |
...
- finding/claim review package 후보를 실제 `/api/redteam/v2/findings` 생성, 2인 severity 승인, Report claim validation으로 통과시킨 증거
