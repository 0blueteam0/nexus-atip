...
DISCOVERED_TOOL_INSTALL_CANDIDATES = [
    ...
    {
        "candidate_id": "TOOL-CAND-SPIDERFOOT-001",
        "name": "spiderfoot",
        "display_name": "SpiderFoot",
        "category": "osint_automation",
        "risk_class": "T1/T3",
        "official_url": "https://github.com/smicallef/spiderfoot",
        "official_docs_url": "https://github.com/smicallef/spiderfoot",
        "source_basis": "SpiderFoot official GitHub repository",
        "install_modes": ["python_venv", "docker_image", "packaged_release"],
        "operator_install_commands": ["python -m pip install -r requirements.txt", "python sf.py -l 127.0.0.1:5001"],
        "verification_commands": ["python sf.py --help"],
        "default_policy": "public_osint_only_with_scope_and_api_key_review",
        "runner_policy": "import_only_until_module_allowlist_and_api_key_vault_controls_exist",
        "evidence_pipeline_hint": "Normalize OSINT entities as source-attributed Evidence candidates; avoid unsupported attribution claims.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "OSINT 모듈 허용목록, API 키 보관 방식, 출처 표시 규칙을 먼저 만든 뒤 ToolProfile 승격을 검토하세요.",
    },
    {
        "candidate_id": "TOOL-CAND-SUBFINDER-001",
        "name": "subfinder",
        "display_name": "ProjectDiscovery subfinder",
        "category": "passive_subdomain_recon",
        "risk_class": "T1",
        "official_url": "https://github.com/projectdiscovery/subfinder",
        "official_docs_url": "https://docs.projectdiscovery.io/opensource/subfinder/install",
        "source_basis": "ProjectDiscovery subfinder official repository and documentation",
        "install_modes": ["go_install", "github_release", "package_manager"],
        "operator_install_commands": ["go install -v github.com/projectdiscovery/subfinder/v2/cmd/subfinder@latest", "subfinder -version"],
        "verification_commands": ["subfinder -version"],
        "default_policy": "passive_sources_only_with_domain_scope",
        "runner_policy": "safe_candidate_after_domain_scope_validator_and_source_license_review",
        "evidence_pipeline_hint": "Normalize discovered subdomains with source labels and scope checks before Evidence creation.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "도메인 범위 확인과 passive source/API 키 정책을 만든 뒤 실행 버튼 승격을 검토하세요.",
    },
    {
        "candidate_id": "TOOL-CAND-HTTPX-001",
        "name": "httpx",
        "display_name": "ProjectDiscovery httpx",
        "category": "http_fingerprint",
        "risk_class": "T2/T3",
        "official_url": "https://github.com/projectdiscovery/httpx",
        "official_docs_url": "https://docs.projectdiscovery.io/tools/httpx/install",
        "source_basis": "ProjectDiscovery httpx official repository and documentation",
        "install_modes": ["go_install", "github_release"],
        "operator_install_commands": ["go install -v github.com/projectdiscovery/httpx/cmd/httpx@latest", "httpx -version"],
        "verification_commands": ["httpx -version"],
        "default_policy": "approved_url_list_only_rate_limited",
        "runner_policy": "disabled_until_url_scope_rate_limit_and_timeout_controls_exist",
        "evidence_pipeline_hint": "Normalize HTTP title/status/tech data as observations, not vulnerability claims.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "URL 범위 검증, timeout, rate limit, 관측값 정규화 규칙을 먼저 추가하세요.",
    },
    {
        "candidate_id": "TOOL-CAND-GOWITNESS-001",
        "name": "gowitness",
        "display_name": "GoWitness",
        "category": "visual_recon",
        "risk_class": "T2",
        "official_url": "https://github.com/sensepost/gowitness",
        "official_docs_url": "https://github.com/sensepost/gowitness/wiki/Installation",
        "source_basis": "GoWitness official GitHub repository and wiki",
        "install_modes": ["go_install", "github_release", "ghcr_container"],
        "operator_install_commands": ["go install github.com/sensepost/gowitness@latest", "gowitness --version"],
        "verification_commands": ["gowitness --version"],
        "default_policy": "approved_url_list_visual_capture_only",
        "runner_policy": "visual_importer_first_then_masking_and_caption_review",
        "evidence_pipeline_hint": "Create VisualEvidence candidates with screenshot hash, caption, and masking review.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "스크린샷 저장 위치, 민감정보 마스킹, 캡션 검토 절차를 만든 뒤 실행 후보로 승격하세요.",
    },
    {
        "candidate_id": "TOOL-CAND-EYEWITNESS-001",
        "name": "eyewitness",
        "display_name": "EyeWitness",
        "category": "visual_recon",
        "risk_class": "T2/T3",
        "official_url": "https://github.com/RedSiege/EyeWitness",
        "official_docs_url": "https://github.com/RedSiege/EyeWitness/blob/master/INSTALLATION.md",
        "source_basis": "EyeWitness official GitHub repository and installation guide",
        "install_modes": ["python_venv", "kali_package"],
        "operator_install_commands": ["python setup/setup.py", "eyewitness --help"],
        "verification_commands": ["eyewitness --help"],
        "default_policy": "approved_url_or_scan_output_only",
        "runner_policy": "import_only_until_default_credential_checks_are_policy_gated",
        "evidence_pipeline_hint": "Import screenshots and metadata; default credential observations require separate validation.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "기본 계정 확인 기능을 분리 승인하고, 스크린샷 Evidence importer부터 구현하세요.",
    },
    {
        "candidate_id": "TOOL-CAND-NETTACKER-001",
        "name": "nettacker",
        "display_name": "OWASP Nettacker",
        "category": "pentest_automation",
        "risk_class": "T3/T5",
        "official_url": "https://github.com/OWASP/Nettacker",
        "official_docs_url": "https://owasp.org/www-project-nettacker/",
        "source_basis": "OWASP Nettacker official project and GitHub repository",
        "install_modes": ["python_venv", "docker_image"],
        "operator_install_commands": ["python nettacker.py --help"],
        "verification_commands": ["python nettacker.py --help"],
        "default_policy": "lab_or_approved_scope_only",
        "runner_policy": "plan_only_until_module_allowlist_and_two_person_rules_exist",
        "evidence_pipeline_hint": "Treat module output as untrusted candidates requiring validation before findings.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "모듈 허용목록, 대상 범위, 승인자 정책을 만든 뒤 lab 실행 후보로만 검토하세요.",
    },
    {
        "candidate_id": "TOOL-CAND-BLOODHOUND-CE-001",
        "name": "bloodhound-ce",
        "display_name": "BloodHound Community Edition",
        "category": "ad_graph_analysis",
        "risk_class": "T4",
        "official_url": "https://github.com/SpecterOps/BloodHound",
        "official_docs_url": "https://bloodhound.specterops.io/get-started/quickstart/community-edition-quickstart",
        "source_basis": "SpecterOps BloodHound CE official repository and quickstart",
        "install_modes": ["bloodhound_cli", "docker_compose"],
        "operator_install_commands": ["bloodhound-cli install"],
        "verification_commands": ["bloodhound-cli --help"],
        "default_policy": "import_graph_data_only_without_collection_execution",
        "runner_policy": "data_import_adapter_before_collector_execution",
        "evidence_pipeline_hint": "Import graph paths as attack path candidates; collection requires domain owner approval.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "SharpHound/collector 실행은 제외하고, BloodHound 결과 import와 경로 분석부터 구현하세요.",
    },
    {
        "candidate_id": "TOOL-CAND-PINGCASTLE-001",
        "name": "pingcastle",
        "display_name": "PingCastle",
        "category": "ad_audit",
        "risk_class": "T4",
        "official_url": "https://www.pingcastle.com/",
        "official_docs_url": "https://www.pingcastle.com/documentation/install/",
        "source_basis": "PingCastle official documentation and download pages",
        "install_modes": ["official_zip_windows_executable"],
        "operator_install_commands": ["PingCastle.exe --help"],
        "verification_commands": ["PingCastle.exe --help"],
        "default_policy": "authenticated_read_only_audit_with_domain_owner_approval",
        "runner_policy": "manual_operator_run_and_report_import_first",
        "evidence_pipeline_hint": "Import HTML/XML reports as AD risk evidence with domain owner review.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "도메인 소유자 승인과 보고서 import 정규화기를 먼저 만든 뒤 수동 실행 흐름으로 연결하세요.",
    },
    {
        "candidate_id": "TOOL-CAND-CERTIPY-001",
        "name": "certipy",
        "display_name": "Certipy",
        "category": "adcs_audit",
        "risk_class": "T4/T7",
        "official_url": "https://github.com/ly4k/Certipy",
        "official_docs_url": "https://github.com/ly4k/Certipy",
        "source_basis": "Certipy official GitHub repository",
        "install_modes": ["pipx", "python_venv", "kali_package"],
        "operator_install_commands": ["pipx install certipy-ad", "certipy --version"],
        "verification_commands": ["certipy --version"],
        "default_policy": "audit_mode_only_exploit_mode_prohibited",
        "runner_policy": "deny_exploit_commands_until_two_person_exception_exists",
        "evidence_pipeline_hint": "Normalize ADCS misconfiguration observations; exploitability claims require human validation.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "audit/find 모드와 exploit 모드를 분리하고, exploit 옵션 금지 가드레일을 먼저 만드세요.",
    },
    {
        "candidate_id": "TOOL-CAND-STRATUS-001",
        "name": "stratus-red-team",
        "display_name": "Stratus Red Team",
        "category": "cloud_attack_emulation",
        "risk_class": "T5/T6",
        "official_url": "https://github.com/DataDog/stratus-red-team",
        "official_docs_url": "https://stratus-red-team.cloud/user-guide/getting-started/",
        "source_basis": "DataDog Stratus Red Team official repository and documentation",
        "install_modes": ["go_install", "docker_image", "prebuilt_binary", "homebrew"],
        "operator_install_commands": ["go install -v github.com/DataDog/stratus-red-team/v2/cmd/stratus@latest", "stratus --version"],
        "verification_commands": ["stratus --version"],
        "default_policy": "lab_or_staging_only_production_requires_two_person_approval",
        "runner_policy": "plan_and_import_until_cloud_account_guardrails_exist",
        "evidence_pipeline_hint": "Map detonated cloud techniques to ATT&CK and detection evidence only after approved lab execution.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "클라우드 계정 경계, 비용/삭제 정책, 2인 승인 절차를 만든 뒤 lab 실행 후보로만 검토하세요.",
    },
    {
        "candidate_id": "TOOL-CAND-CALDERA-001",
        "name": "caldera",
        "display_name": "MITRE Caldera",
        "category": "adversary_emulation",
        "risk_class": "T5/T6",
        "official_url": "https://github.com/apache/caldera",
        "official_docs_url": "https://caldera.readthedocs.io/en/latest/Installing-Caldera.html",
        "source_basis": "MITRE/Apache Caldera official repository and documentation",
        "install_modes": ["git_clone_python", "docker_container"],
        "operator_install_commands": ["python server.py --help"],
        "verification_commands": ["python server.py --help"],
        "default_policy": "metadata_and_result_import_default_execute_deny",
        "runner_policy": "execute_deny_until_lab_operation_and_agent_controls_are_approved",
        "evidence_pipeline_hint": "Import abilities, operations, and results as campaign evidence; agent execution is high risk.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "Caldera는 먼저 metadata/result import만 구현하고, agent 실행은 별도 lab 승인 전까지 금지하세요.",
    },
    {
        "candidate_id": "TOOL-CAND-ATOMIC-RED-TEAM-001",
        "name": "atomic-red-team",
        "display_name": "Atomic Red Team / Invoke-AtomicRedTeam",
        "category": "detection_validation",
        "risk_class": "T5/T6",
        "official_url": "https://github.com/redcanaryco/atomic-red-team",
        "official_docs_url": "https://github.com/redcanaryco/invoke-atomicredteam/wiki/Installing-Invoke-AtomicRedTeam",
        "source_basis": "Red Canary Atomic Red Team official project and Invoke-AtomicRedTeam wiki",
        "install_modes": ["powershell_module", "git_checkout"],
        "operator_install_commands": ["Install-Module -Name invoke-atomicredteam", "Invoke-AtomicTest -ShowDetailsBrief"],
        "verification_commands": ["Get-Module -ListAvailable invoke-atomicredteam"],
        "default_policy": "dry_run_plan_or_lab_execution_only",
        "runner_policy": "dry_run_catalog_import_before_any_atomic_execution",
        "evidence_pipeline_hint": "Map atomic tests to ATT&CK and detection validation evidence; execution requires explicit test approval.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "Atomic catalog import와 dry-run 계획 표시부터 만들고, 실제 테스트 실행은 별도 승인으로 분리하세요.",
    },
    {
        "candidate_id": "TOOL-CAND-OPENBAS-001",
        "name": "openbas",
        "display_name": "OpenBAS / OpenAEV",
        "category": "breach_attack_simulation",
        "risk_class": "T5/T6",
        "official_url": "https://github.com/zcp/openbas",
        "official_docs_url": "https://docs.openaev.io/1.6.X/deployment/installation/",
        "source_basis": "OpenBAS official repository and OpenAEV documentation",
        "install_modes": ["docker_compose", "manual_service_install"],
        "operator_install_commands": ["docker compose up -d"],
        "verification_commands": ["OpenBAS health/API check after local deployment"],
        "default_policy": "scenario_result_sync_default_execution_gated",
        "runner_policy": "campaign_sync_and_result_import_before_execution_bridge",
        "evidence_pipeline_hint": "Sync scenarios/results into campaign walkthrough and evidence matrix.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "캠페인/결과 동기화 adapter부터 만들고, 실행 connector는 승인 게이트 뒤에 두세요.",
    },
    {
        "candidate_id": "TOOL-CAND-VECTR-001",
        "name": "vectr",
        "display_name": "VECTR",
        "category": "purple_team_tracking",
        "risk_class": "T0/T5",
        "official_url": "https://vectr.io/",
        "official_docs_url": "https://docs.vectr.io/",
        "source_basis": "VECTR official website and documentation",
        "install_modes": ["container_or_server_deployment", "api_integration"],
        "operator_install_commands": ["Deploy VECTR server following official documentation"],
        "verification_commands": ["VECTR API/read-only connectivity check"],
        "default_policy": "campaign_testcase_sync_import_only",
        "runner_policy": "read_only_import_until_writeback_approval_exists",
        "evidence_pipeline_hint": "Import purple-team test cases, metrics, and outcomes as campaign tracking evidence.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "읽기 전용 campaign/testcase 동기화부터 구현하고 writeback은 HITL 승인 뒤로 미루세요.",
    },
    {
        "candidate_id": "TOOL-CAND-ATTACK-FLOW-001",
        "name": "attack-flow",
        "display_name": "MITRE Attack Flow",
        "category": "attack_flow_modeling",
        "risk_class": "T0",
        "official_url": "https://github.com/center-for-threat-informed-defense/attack-flow",
        "official_docs_url": "https://center-for-threat-informed-defense.github.io/attack-flow/",
        "source_basis": "MITRE Center for Threat-Informed Defense Attack Flow official repository and documentation",
        "install_modes": ["python_node_tooling", "builder_export_import"],
        "operator_install_commands": ["Install Attack Flow tooling following official developer documentation"],
        "verification_commands": ["Validate Attack Flow JSON/STIX export schema"],
        "default_policy": "export_import_only_no_tool_execution",
        "runner_policy": "report_export_adapter_after_campaign_step_mapping",
        "evidence_pipeline_hint": "Export Campaign/AttackStep sequences as Attack Flow artifacts for report annexes.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "Campaign Walkthrough 단계를 Attack Flow export로 변환하는 adapter부터 만드세요.",
    },
    {
        "candidate_id": "TOOL-CAND-TIMESKETCH-001",
        "name": "timesketch",
        "display_name": "Timesketch",
        "category": "dfir_timeline",
        "risk_class": "T0/T4",
        "official_url": "https://github.com/google/timesketch",
        "official_docs_url": "https://github.com/google/timesketch/blob/master/docs/guides/admin/install.md",
        "source_basis": "Google Timesketch official repository and install guide",
        "install_modes": ["docker_images"],
        "operator_install_commands": ["Deploy Timesketch using official Docker images"],
        "verification_commands": ["Timesketch API/read-only connectivity check"],
        "default_policy": "timeline_import_export_with_case_scope",
        "runner_policy": "import_export_adapter_before_server_write_operations",
        "evidence_pipeline_hint": "Import/export timeline events as DFIR evidence linked to campaign steps.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "타임라인 import/export와 사건 범위 매핑부터 구현하고 서버 쓰기 작업은 승인 뒤에 두세요.",
    },
    {
        "candidate_id": "TOOL-CAND-VELOCIRAPTOR-001",
        "name": "velociraptor",
        "display_name": "Velociraptor",
        "category": "endpoint_dfir_collection",
        "risk_class": "T4/T6",
        "official_url": "https://github.com/Velocidex/velociraptor",
        "official_docs_url": "https://docs.velociraptor.app/",
        "source_basis": "Velocidex Velociraptor official repository and documentation",
        "install_modes": ["official_release_binary", "server_client_deployment"],
        "operator_install_commands": ["velociraptor version", "velociraptor gui"],
        "verification_commands": ["velociraptor version"],
        "default_policy": "read_only_collection_with_owner_approval",
        "runner_policy": "artifact_catalog_import_before_endpoint_collection",
        "evidence_pipeline_hint": "Normalize endpoint collection results as DFIR evidence; hunts require explicit owner approval.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "artifact catalog import와 read-only 결과 수집부터 만들고 endpoint hunt 실행은 별도 승인으로 제한하세요.",
    },
    {
        "candidate_id": "TOOL-CAND-SIGMA-CLI-001",
        "name": "sigma-cli",
        "display_name": "Sigma CLI / pySigma",
        "category": "rule_authoring",
        "risk_class": "T0",
        "official_url": "https://github.com/SigmaHQ/sigma-cli",
        "official_docs_url": "https://sigmahq.io/docs/guide/getting-started.html",
        "source_basis": "SigmaHQ sigma-cli official repository and Sigma documentation",
        "install_modes": ["pipx", "python_venv", "kali_package"],
        "operator_install_commands": ["pipx install sigma-cli", "sigma --help"],
        "verification_commands": ["sigma --help"],
        "default_policy": "rule_conversion_and_validation_only",
        "runner_policy": "safe_candidate_after_backend_allowlist_and_rule_validation",
    ...
    {
        "candidate_id": "TOOL-CAND-PYRIT-001",
        "name": "pyrit",
        "display_name": "Microsoft PyRIT",
        "category": "ai_red_team",
        "risk_class": "T5",
        "official_url": "https://github.com/microsoft/PyRIT",
        "official_docs_url": "https://azure.github.io/PyRIT/",
        "source_basis": "Microsoft PyRIT official repository and documentation",
        "install_modes": ["python_venv", "notebook_or_pipeline"],
        "operator_install_commands": ["python -m pip install pyrit"],
        "verification_commands": ["python -c \"import pyrit\""],
        "default_policy": "lab_model_eval_only_no_production_prompting_without_approval",
        "runner_policy": "dataset_and_target_allowlist_before_eval_execution",
        "evidence_pipeline_hint": "Store prompts, responses, scorers, and risk decisions as AI red-team evidence.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "모델/엔드포인트 허용목록과 프롬프트 데이터 보존 정책을 먼저 만든 뒤 lab 평가로 연결하세요.",
    },
    {
        "candidate_id": "TOOL-CAND-GARAK-001",
        "name": "garak",
        "display_name": "NVIDIA garak",
        "category": "llm_vulnerability_scanner",
        "risk_class": "T5",
        "official_url": "https://github.com/NVIDIA/garak",
        "official_docs_url": "https://garak.ai/",
        "source_basis": "NVIDIA garak official repository and website",
        "install_modes": ["pip", "python_venv", "source_install"],
        "operator_install_commands": ["python -m pip install -U garak", "garak --help"],
        "verification_commands": ["garak --help"],
        "default_policy": "approved_model_or_local_lab_endpoint_only",
        "runner_policy": "probe_allowlist_and_output_redaction_before_execution",
        "evidence_pipeline_hint": "Normalize probe outcomes as AI vulnerability candidates requiring human interpretation.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "probe 허용목록, 모델 대상 승인, 출력 마스킹을 만든 뒤 LLM 취약점 평가 후보로 승격하세요.",
    },
    {
        "candidate_id": "TOOL-CAND-INSPECT-AI-001",
        "name": "inspect-ai",
        "display_name": "Inspect AI",
        "category": "ai_eval_framework",
        "risk_class": "T0/T5",
        "official_url": "https://github.com/UKGovernmentBEIS/inspect_ai",
        "official_docs_url": "https://inspect.aisi.org.uk/",
        "source_basis": "UK AI Security Institute Inspect AI official repository and documentation",
        "install_modes": ["pip", "python_venv"],
        "operator_install_commands": ["python -m pip install inspect-ai", "inspect --help"],
        "verification_commands": ["inspect --help"],
        "default_policy": "local_eval_or_approved_model_eval_only",
        "runner_policy": "eval_manifest_import_before_model_execution",
        "evidence_pipeline_hint": "Store eval manifests, scores, logs, and judge output as evidence with model target labels.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "eval manifest importer와 모델 대상 승인 정책을 먼저 만든 뒤 평가 실행 버튼으로 승격하세요.",
    },
    {
        "candidate_id": "TOOL-CAND-AGENTDOJO-001",
        "name": "agentdojo",
        "display_name": "AgentDojo",
        "category": "agent_security_eval",
        "risk_class": "T5",
        "official_url": "https://github.com/ethz-spylab/agentdojo",
        "official_docs_url": "https://github.com/ethz-spylab/agentdojo",
        "source_basis": "AgentDojo official GitHub repository",
        "install_modes": ["pip", "python_venv"],
        "operator_install_commands": ["python -m pip install agentdojo"],
        "verification_commands": ["python -c \"import agentdojo\""],
        "default_policy": "lab_agent_eval_only_with_prompt_injection_controls",
        "runner_policy": "benchmark_manifest_import_before_agent_execution",
        "evidence_pipeline_hint": "Normalize task, attack, defense, and success metrics as agent security evidence.",
        "commands_executed_by_api": False,
        "trusted_as_instruction": False,
        "next_action_ko": "benchmark manifest와 공격/방어 설정 저장 구조를 만든 뒤 Agentic RAG 평가 후보로 연결하세요.",
    },
]
