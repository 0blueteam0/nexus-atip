# Live Actor Binding Report

## 문서 통제

- Case ID: `CASE-LIVE-ACTOR-BINDING-001`
- 생성 시각: `2026-07-01T04:39:16Z`
...
|---|---|---|
| `C-LIVE-ACTOR-001` | supported | EV-LIVE-ACTOR-001 |

## Findings

- `F-LIVE-ACTOR-001` Finding / Evidence: EV-LIVE-ACTOR-001

## ToolAction / HITL Summary

- `TAC-LIVE-ACTOR-001` risk=T3 status=EvidenceCreated approval_required=True
