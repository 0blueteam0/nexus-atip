Handoff: Continue tool installation with the same evidence pattern. The next agent should not treat detect-secrets completion as whole-platform completion.
Evidence fields:
