Capability registry: TOOL-DETECT-SECRETS-001 supports local secret candidate detection for approved workspaces only and produces secret_exposure_candidate Evidence candidates.
Evidence fields:
