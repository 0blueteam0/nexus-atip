Task summary: Install detect-secrets 1.5.0, add clean sample workspace, promote to optional runner, connect normalizer and LLM analyst agent, verify backend/frontend/governed smoke, and keep the global goal active.
Evidence fields:
