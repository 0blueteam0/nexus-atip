Decision ledger: detect-secrets is optional local secret scan coverage. It is safe only for approved clean/redacted workspaces and must not run audit or baseline mutation from a frontend button.
Evidence fields:
