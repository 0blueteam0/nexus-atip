...
J:\PortableApps\genai\projects\ai-agentic-soc\.venv\Scripts\python.exe -m pytest J:\PortableApps\genai\projects\ai-agentic-soc\tests\test_redteam_v2_api_router.py -k "safe_smoke_candidate_attestation_records_install_evidence_without_runner_unlock or safe_local_smoke_allows_high_risk_version_only_dry_run or tool_install_version_evidence_records_operator_attested_versions"
...
All commands exited 0. The only non-failure output was CRLF normalization warnings from Git and a Starlette deprecation warning from pytest dependencies.
