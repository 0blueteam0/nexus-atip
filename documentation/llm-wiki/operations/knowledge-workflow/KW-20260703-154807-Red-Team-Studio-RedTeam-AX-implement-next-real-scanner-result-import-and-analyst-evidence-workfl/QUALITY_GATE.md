...
| Official docs separated from work meta | pass | command evidence only in KW |
| Encoding/log verification passed | pass | UTF-8 PowerShell/PYTHONUTF8 used for Korean paths |
| qmd update considered | pass | LLM Wiki calling rule updated; no qmd required |
