...
|---|---|---:|---:|---|---|
| EV-001 | source | `redteam_v2_models.py` | n/a | `projects/ai-agentic-soc/runtime/redteam_v2_models.py` | Matrix/report bridge added |
| EV-002 | source | `redteam_v2_api_router.py` | n/a | `projects/ai-agentic-soc/runtime/redteam_v2_api_router.py` | API routes exposed |
