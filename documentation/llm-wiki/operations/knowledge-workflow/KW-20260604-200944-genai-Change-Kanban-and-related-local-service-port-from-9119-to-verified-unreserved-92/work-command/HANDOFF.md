...
- next_actor_note: Use `hermes-codex.bat --chat` to open the browser chat at 9203; do not revert to 9119 unless Windows excluded ranges change and the port is tested.
