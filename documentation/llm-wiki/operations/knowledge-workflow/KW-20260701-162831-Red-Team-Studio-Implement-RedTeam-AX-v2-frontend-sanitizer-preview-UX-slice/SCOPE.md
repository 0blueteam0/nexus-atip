...
- Project: Red-Team-Studio
- Slice: RedTeam AX v2 frontend sanitizer preview UX
- Objective: Surface the backend ToolOutputSanitizer preview in the Report Studio `레드팀 분석2` panel so analysts can inspect quarantine/redaction state before LLM normalization/report use.
- In scope:
...
- Out of scope:
  ...
  - Browser automation screenshot assertion
  - Backend sanitizer changes
  - OCR/image redaction
