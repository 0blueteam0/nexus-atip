...
- Codex/Hermes agent: implemented collection/bbox/local-substitution cycle, tests, manifests, and workflow evidence.
- No subagents were used in the final continuation segment.
