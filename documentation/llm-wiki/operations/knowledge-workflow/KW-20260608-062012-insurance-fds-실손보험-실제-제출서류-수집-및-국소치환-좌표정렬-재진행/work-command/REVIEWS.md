...
- Code review focus: same-bbox paste uses bbox-sized crop, preventing anti-aliased pixels from escaping target bbox.
- Test review: network-dependent test was replaced by deterministic local fake-PDF test.
- Visual review: contact sheet shows actual submission forms and no shortcut labels inside document pixels.
