...
| EV-003 | focused regression | `.venv/Scripts/python.exe -m pytest tests/test_redteam_v2_api_router.py -k "operating_closure_human_review" -q` | 0 | test output: 1 passed | 2026-07-03 |
| EV-004 | full router regression | `.venv/Scripts/python.exe -m pytest tests/test_redteam_v2_api_router.py -q` | 0 | test output: 66 passed, 1 warning | 2026-07-03 |
