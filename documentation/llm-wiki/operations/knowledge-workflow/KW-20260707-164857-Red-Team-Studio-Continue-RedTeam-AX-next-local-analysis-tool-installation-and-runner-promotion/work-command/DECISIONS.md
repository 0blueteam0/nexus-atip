Decision ledger: YARA is optional local analysis coverage. It is safe only for approved rule/input files and must not run recursive or arbitrary scans from a frontend button.
Evidence fields:
