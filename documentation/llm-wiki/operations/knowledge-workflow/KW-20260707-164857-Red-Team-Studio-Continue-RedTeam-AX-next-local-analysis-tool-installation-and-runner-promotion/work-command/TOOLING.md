Tooling: YARA v4.5.5 official release, yara64.exe hash pinned, preset PRESET-YARA-LOCAL-RULE-MATCH, normalizer NORMALIZER-YARA-001, agent AGENT-YARA-ANALYST-001.
Evidence fields:
