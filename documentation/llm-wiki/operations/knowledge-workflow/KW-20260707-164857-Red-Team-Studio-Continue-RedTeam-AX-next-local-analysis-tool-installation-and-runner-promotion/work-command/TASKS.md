Task summary: Install YARA v4.5.5, add safe local workspace, promote to optional runner, connect normalizer and LLM analyst agent, verify backend/frontend/governed smoke, and keep the global goal active.
Evidence fields:
