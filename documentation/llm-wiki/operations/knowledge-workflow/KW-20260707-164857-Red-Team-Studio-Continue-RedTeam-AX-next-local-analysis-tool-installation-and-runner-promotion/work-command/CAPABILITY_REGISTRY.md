Capability registry: TOOL-YARA-001 supports local indicator rule matching for approved workspaces only and produces local_indicator_match Evidence candidates.
Evidence fields:
