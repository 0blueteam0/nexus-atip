Source quality: SPEC 23 is the local authoritative requirement source. PyPI/GitHub are official install references. Local command outputs are execution evidence.
Evidence fields:
