Capability registry: TOOL-BANDIT-001 supports local Python static security checks for approved files only and produces python_static_security_observation Evidence candidates.
Evidence fields:
