...
## Summary
Decisions: install LangGraph after user approval; keep OTRF no-download contract-only; use actual StateGraph compile/invoke; delegate Kanban UX to background cron job.
