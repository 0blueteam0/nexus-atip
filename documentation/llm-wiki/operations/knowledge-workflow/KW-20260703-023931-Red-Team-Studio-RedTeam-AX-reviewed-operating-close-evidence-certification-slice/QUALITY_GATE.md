...
| Official docs separated from work meta | passed | Command evidence in session; product docs contain durable updates. |
| Encoding/log verification passed | passed | Korean copy sanity passed. |
| qmd update considered | passed | LLM Wiki Markdown updated; no qmd source required. |