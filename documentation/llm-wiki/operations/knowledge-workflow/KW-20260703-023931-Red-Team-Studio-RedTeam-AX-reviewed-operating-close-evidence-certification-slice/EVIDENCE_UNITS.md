...
| EV-003 | focused regression | `.venv/Scripts/python.exe -m pytest tests/test_redteam_v2_api_router.py -k "certify_reviewed_operating_close_evidence" -q` | 0 | test output: 1 passed | 2026-07-03 |
| EV-004 | full router regression | `.venv/Scripts/python.exe -m pytest tests/test_redteam_v2_api_router.py -q` | 0 | test output: 68 passed, 1 warning | 2026-07-03 |
