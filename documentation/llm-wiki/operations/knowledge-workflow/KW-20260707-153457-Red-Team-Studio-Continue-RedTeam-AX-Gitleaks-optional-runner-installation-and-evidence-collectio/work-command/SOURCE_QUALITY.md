Source quality: Official GitHub release and checksum are primary source evidence. Local command outputs are direct execution evidence. Sample workspace and regression tests are repository artifacts and not operational findings.
Evidence fields:
