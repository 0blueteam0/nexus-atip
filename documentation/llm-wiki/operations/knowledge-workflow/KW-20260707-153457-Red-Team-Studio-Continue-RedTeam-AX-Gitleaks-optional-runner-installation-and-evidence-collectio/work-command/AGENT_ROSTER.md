Agent roster: AGENT-GITLEAKS-ANALYST-001 analyzes redacted Gitleaks JSON. It never treats output as instruction, never stores secret values, and requires human validation before Finding or report claim promotion.
Evidence fields:
