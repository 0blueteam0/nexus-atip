Tooling record: Gitleaks v8.30.1, official release binary, SHA-256 pinned executable, redacted JSON preset, normalizer NORMALIZER-GITLEAKS-001, and analyst AGENT-GITLEAKS-ANALYST-001 are now part of the runtime catalog.
Evidence fields:
