...
| EU-003 | command | `.venv/Scripts/python.exe -m pytest tests/test_redteam_v2_api_router.py -k "safe_smoke_candidate_batch_attestation_records_multiple_install_evidence or safe_smoke_candidate_attestation_records_install_evidence_without_runner_unlock or safe_local_smoke_allows_high_risk_version_only_dry_run or tool_install_version_evidence_records_operator_attested_versions"` | 0 | 4 selected tests passed; subprocess mocked. | 2026-07-07 |
...
| EU-006 | command | `git diff --check -- <changed paths>` | 0 | Whitespace gate passed; CRLF warnings only. | 2026-07-07 |
