...
J:\PortableApps\genai\projects\ai-agentic-soc\.venv\Scripts\python.exe -m pytest J:\PortableApps\genai\projects\ai-agentic-soc\tests\test_redteam_v2_api_router.py -k "safe_smoke_candidate_batch_attestation_records_multiple_install_evidence or safe_smoke_candidate_attestation_records_install_evidence_without_runner_unlock or safe_local_smoke_allows_high_risk_version_only_dry_run or tool_install_version_evidence_records_operator_attested_versions"
...
All exited 0. Pytest used mocked subprocess, so no actual scanner process was started.
