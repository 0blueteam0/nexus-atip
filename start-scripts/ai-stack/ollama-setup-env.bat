...
setx OLLAMA_MODELS "K:\PortableApps\Claude-Code\ollama-models"

echo [+] 환경 변수 설정 완료!
echo.
echo OLLAMA_MODELS = K:\PortableApps\Claude-Code\ollama-models
echo.
echo [!] 변경사항 적용을 위해 터미널을 재시작하거나 다음 명령어 실행:
echo     set OLLAMA_MODELS=K:\PortableApps\Claude-Code\ollama-models
echo.
