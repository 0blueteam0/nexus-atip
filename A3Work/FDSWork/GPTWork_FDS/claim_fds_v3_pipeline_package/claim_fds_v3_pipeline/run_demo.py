...
""", encoding="utf-8")
    ...
    v4_reference_dir = ROOT.parents[2] / "Real Image"
    v4_result = generate_v4_lab(OUT / "v4_lab", v4_reference_dir, seed=cfg["seed"] + 1)
    print(json.dumps({"ok": True, "outputs": str(OUT), "qc": qc, "v4_lab": v4_result}, ensure_ascii=False, indent=2))
