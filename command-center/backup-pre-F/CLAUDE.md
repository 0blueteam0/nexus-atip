...
### 자동 Plan Mode (복잡도 감지 → 자율 진입)
- **엔진**: `atos/complexity-detector.js`
- **규칙**: `.claude/rules/auto-plan-mode.md`
- 0~4점: 직접 실행 | 5~7점: Plan Mode 제안 | 8+점: Plan Mode 자동 권장
...
| `auto-plan-mode.md` | **자동 Plan Mode 활용** (복잡도 감지 → 자율 진입) |
